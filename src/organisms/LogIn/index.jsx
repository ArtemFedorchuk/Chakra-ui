...
const LogIn = () => {
	...
	return (
		<div className={styles.formWrapper}>
			<Stack spacing={3}>
				<Text fontSize='3xl'>Log In to CRYPT TOOL</Text>
			</Stack>
			<form action='' className={styles.form}>
				<Stack spacing={6}>
					<InputGroup>
						<InputLeftElement pointerEvents='none' children={<HiAtSymbol color='gray.300' />} />
						<Input
							type='phone'
							placeholder='Email'
				...
				<div className={styles.btnGroup}>
					{sendInfo ? (
						...
						<button onClick={sendHandler} type='button' className={styles.button}>
							Sign In
						</button>
					)}
					<button onClick={clearHandler} className={styles.button}>
						clear
					</button>
					<br />
				</div>
